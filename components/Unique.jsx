    ...
    <div className='w-full sm:px-8 md:px-12 md:pt-20'>
      <div className='bg-heading radius p-4 sm:p-6 md:p-8 text-white z-50 relative'>
        ...
        <div className='hidden md:block container mx-auto px-4 md:px-6  lg:px-8 max-w-7xl'>
          ...
          <div className='flex flex-col lg:flex-row w-full md:mb-72 gap-8 lg:gap-12 px-4 lg:px-14'>
            {/* Left side content */}
            <div className='w-full lg:w-1/2'>
              ...
              <div className='space-y-4 relative h-80'>
                <div className='bg-blue-200 flex flex-col justify-center gap-2 w-36 md:w-48 h-40 md:h-52 bg-opacity-30 p-4 rounded-2xl backdrop-blur-sm absolute top-0 left-0'>
                  <Image
                    src='/web-site (2).png'
                    height={40}
                    width={40}
                ...
                <div className='bg-blue-200 flex flex-col justify-center gap-2 w-36 md:w-48 h-40 md:h-52 bg-opacity-30 p-4 rounded-2xl backdrop-blur-sm z-10 absolute -bottom-28 left-0'>
                  <Image
                    src='/web-site (1).png'
                    height={40}
                    width={40}
                ...
                <div className='absolute top-10 left-24 md:left-40'>
                  <div className='bg-blue-200 flex flex-col justify-center gap-2 w-36 md:w-48 h-40 md:h-52 bg-opacity-30 p-4 rounded-2xl backdrop-blur-sm z-50'>
            ...
            <div className='w-full lg:w-1/2 relative h-[550px] mt-20 lg:mt-0'>
              ...
              {/* Center card */}
              <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-blue-200 flex flex-col items-center justify-center gap-2 w-64 md:w-96 h-36 md:h-44 bg-opacity-30 p-4 py-20 rounded-2xl backdrop-blur-sm z-10'>
      ...
      group-hover:shadow-xl group-hover:scale-x-110"
          ...
          <div className='absolute left-0 bottom-0 pt-16 md:mt-5 '>
            <Image
              src='/Group 21.png'
              alt='Ellipse'
              width={300}
